...
export default function ChatInterface() {
  ...
  const handleSend = (e) => {
    ...
    setTimeout(() => {
      const responses = [
        { text: "That's an interesting perspective! Tell me more.", emotion: "Curious", pad: [0.6, 0.7, 0.4] },
        { text: "I completely understand how you feel.", emotion: "Empathetic", pad: [0.3, 0.8, -0.2] },
        { text: "Let me process that for a moment...", emotion: "Thoughtful", pad: [0.2, 0.4, 0.8] }
      ];
      const res = responses[Math.floor(Math.random() * responses.length)];
      
      setEmotionState({ name: res.emotion, pad: res.pad });
